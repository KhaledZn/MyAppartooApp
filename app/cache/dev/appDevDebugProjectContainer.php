...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'myprojectappartoouser.form_registration' => 'getMyprojectappartoouser_FormRegistrationService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MyProjectAppartoo\\RepertoireBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MyProjectAppartoo\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MyProjectAppartoo\\RepertoireBundle\\Entity');
        $c->addDriver($b, 'MyProjectAppartoo\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MyProjectAppartooRepertoireBundle' => 'MyProjectAppartoo\\RepertoireBundle\\Entity', 'MyProjectAppartooUserBundle' => 'MyProjectAppartoo\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c92bc444673cd5b36d553efe47c8dabb6a893abad097884fc69ca7ace8b1488f');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MyProjectAppartoo\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MyProjectAppartoo\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'MyProjectAppartoo_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MyProjectAppartoo\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MyProjectAppartoo\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MyProjectAppartoo\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'myprojectappartoouser.form_registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyProjectAppartoo\UserBundle\Form\RegistrationType A MyProjectAppartoo\UserBundle\Form\RegistrationType instance.
     */
    protected function getMyprojectappartoouser_FormRegistrationService()
    {
        return $this->services['myprojectappartoouser.form_registration'] = new \MyProjectAppartoo\UserBundle\Form\RegistrationType();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('khaled.znaidi@gmail.com');
        $a->setPassword('milanello');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MyProjectAppartoo\\RepertoireBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\MyProjectAppartoo\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml'), 'fr', 'FOSUserBundle');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyProjectAppartoo\\RepertoireBundle/Resources/views'), 'MyProjectAppartooRepertoire');
        $instance->addPath(($this->targetDirs[3].'\\src\\MyProjectAppartoo\\UserBundle/Resources/views'), 'MyProjectAppartooUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyProjectAppartooRepertoireBundle' => 'MyProjectAppartoo\\RepertoireBundle\\MyProjectAppartooRepertoireBundle',
                'MyProjectAppartooUserBundle' => 'MyProjectAppartoo\\UserBundle\\MyProjectAppartooUserBundle',
            ...
            'mailer_user' => 'khaled.znaidi@gmail.com',
            'mailer_password' => 'milanello',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'khaled.znaidi@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'milanello',
            ...
            'fos_user.model.user.class' => 'MyProjectAppartoo\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'MyProjectAppartoo_user_registration',
            ...
            'easyadmin.config' => array(
                'site_name' => 'Appartoo Test :-)',
                'entities' => array(
                    'Contact' => array(
                        'class' => 'MyProjectAppartoo\\RepertoireBundle\\Entity\\Contact',
                        'name' => 'Contact',
                    ),
                ),
                'design' => array(
